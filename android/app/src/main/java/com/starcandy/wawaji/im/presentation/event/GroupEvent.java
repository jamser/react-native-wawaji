package com.starcandy.wawaji.im.presentation.event;
...
public class GroupEvent extends Observable implements TIMGroupAssistantListener {
    ...
    public void onMemberJoin(String s, List<TIMGroupMemberInfo> list) {
        setChanged();
        notifyObservers(new NotifyCmd(NotifyType.MEMBER_JOIN, list,s));
    }
    ...
    public void onMemberQuit(String s, List<String> list) {
        setChanged();
        notifyObservers(new NotifyCmd(NotifyType.MEMBER_QUIT, list,s));
    }

    @Override
    public void onMemberUpdate(String s, List<TIMGroupMemberInfo> list) {
        setChanged();
        notifyObservers(new NotifyCmd(NotifyType.MEMBER_UPDATE, list,s));
    }
    ...
    public class NotifyCmd{
        ...
        NotifyCmd(NotifyType type, Object data,String groupId){
            this.type = type;
            this.data = data;
