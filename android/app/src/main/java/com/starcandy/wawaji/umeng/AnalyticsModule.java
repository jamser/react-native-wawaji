package com.starcandy.wawaji.umeng;
...
public class AnalyticsModule extends ReactContextBaseJavaModule {
    ...
    public void onEvent(String eventId) {
        Logger.d("umeng","eventId--onEvent->"+eventId);
    ...
    public void onEventWithMap(String eventId,ReadableMap map) {
        Logger.d("umeng","eventId--onEventWithMapvent->"+eventId);
        ...
        for(Iterator iter = set.iterator(); iter.hasNext();) {
            ...
            Logger.d("umeng","eventId--onEventWithMap->"+"key:"+key+"-->value:"+value);
        }
    ...
    public void track(String eventName) {
        Logger.e("UMAnalyticsModule","xxxxxx dddddd="+context);
