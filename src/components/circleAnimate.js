...
class PercentageCircle extends Component {
    ...
    componentWillReceiveProps(nextProps) {
        ...
        if (percent >= 50) {
            ...
            leftTransformerDegree = -((percent-50) * 3.6+180)+ 'deg';
        }
        this.setState({
            percent: this.props.percent,
            borderWidth: this.props.borderWidth < 2 || !this.props.borderWidth ? 2 : this.props.borderWidth,
            ...
            <View style={[styles.circle,{
                ...
                <View style={[styles.leftWrap,{
                    ...
                    <View style={[styles.loader,{
                        ...
                        borderLeftColor:this.props.percent < 50 ? this.props.bgcolor : this.props.color,
                        borderTopWidth:this.props.borderWidth,
                        borderTopColor:this.props.percent < 50 ? this.props.bgcolor : this.props.color,
                        borderBottomWidth:this.props.borderWidth,
                        borderBottomColor:this.props.percent < 50 ? this.props.bgcolor : this.props.color,
                ...
                <View style={[styles.innerCircle,{
                    ...
                    {this.props.children ? this.props.children :
                        <Text style={[styles.text, this.state.textStyle,{fontSize:this.props.fontSize}]}>{this.props.data}</Text>}
                </View>
